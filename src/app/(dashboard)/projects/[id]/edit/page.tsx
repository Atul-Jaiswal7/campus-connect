  ...
  if (loading) {
    return (
      <div className="flex min-h-[50vh] flex-col items-center justify-center gap-2">
        ...
        <p className="text-xs text-muted-foreground font-semibold">Loading project data...</p>
      </div>
    );
  }
    ...
    <div className="max-w-3xl mx-auto space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground">Keep your project details and screenshots updated</p>
        </div>
      </div>
